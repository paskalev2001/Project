...
def load_sprite_sheets(dir1, dir2, width, height, direction=False):
    ...
    for image in images:
        ...
        sprites = []
        #This loop cuts spritesheets in different segements
...
def get_block(size):
    ...
    #rect is adjusted to load different images from spritesheet
...
class Player(pygame.sprite.Sprite):
    ...
    #responsible for running the movement
    def loop(self, fps):
        #next line is  gravity implementation
...
def get_background(name):
    #load tile image for background
...
# This is used only if I want game to be ran if executed directly from CLI
# Since I am doing a menu to run the game I don't want this to be executed
# if __name__ == "__main__" or __name__ == "menu.py":
main(game_window)